...
class Hosting extends Model
{
    ...
    protected $fillable = ['client_id', 'name', 'domain', 'description', 'summary', 'date', 'last_renewed', 'next_renewal', 'renewal', 'rate', 'ssl', 'order', 'active',];
    ...
    */
    ...
    /**
     * Ensure next_renewal is set based on last_renewed + renewal_years.
    ...
    */
    ...
    /**
     * Return hosting for a client that renew within a given date range,
